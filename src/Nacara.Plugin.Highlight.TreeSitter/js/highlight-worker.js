// A browser refuses synchronous WebAssembly instantiation above 8 MB on the main thread, and the F# grammar is 9.7 MB inflated.

import { Parser, Language, Query } from "./web-tree-sitter.js";

// This worker sits beside the runtime it imports and the grammars it loads.
