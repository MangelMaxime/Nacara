...
let getRefs () =
    let sdkVersion = NugetVersion(6,0,0, "") //latest3xSdkVersion defaultDotNetSDKRoot
    let runtimeVersion = NugetVersion(6,0,0, "")//latest3xRuntimeVersion defaultDotNetSDKRoot
